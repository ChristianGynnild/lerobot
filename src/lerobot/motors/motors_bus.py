...
class MotorsBus(abc.ABC):
    ...
    @abc.abstractmethod
    def disable_torque(self, motors: int | str | list[str] | None = None, num_retry: int = 100000000) -> None:
    ...
    @abc.abstractmethod
    def _disable_torque(self, motor: int, model: str, num_retry: int = 100000000) -> None:
        pass

    @abc.abstractmethod
    def enable_torque(self, motors: str | list[str] | None = None, num_retry: int = 100000000) -> None:
    ...
    def ping(self, motor: NameOrID, num_retry: int = 100000000, raise_on_error: bool = False) -> int | None:
    ...
    @abc.abstractmethod
    def broadcast_ping(self, num_retry: int = 100000000, raise_on_error: bool = False) -> dict[int, int] | None:
    ...
    def write(
        self, data_name: str, motor: str, value: Value, *, normalize: bool = True, num_retry: int = 100000000
    ) -> None:
