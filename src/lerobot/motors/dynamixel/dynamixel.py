...
class DynamixelMotorsBus(MotorsBus):
    ...
    def disable_torque(self, motors: str | list[str] | None = None, num_retry: int = 100000000) -> None:
        for motor in self._get_motors_list(motors):
            self.write("Torque_Enable", motor, TorqueMode.DISABLED.value, num_retry=num_retry)

    def _disable_torque(self, motor_id: int, model: str, num_retry: int = 100000000) -> None:
